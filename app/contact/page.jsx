...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+234) 905 834 1240",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "quzeemoddusanwo@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form action="https://formsubmit.co/d447e6c485239bce203965399a3f3522" method="POST" className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              <h3 className="text-4xl text-accent-hover">Let's work together</h3>
              <p className="text-white/60">
                If you're interested in working together with me. Kindly fill the form. Thank you.
              </p>
              {/* input */}
